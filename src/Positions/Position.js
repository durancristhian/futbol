...
const Position = ({ position, index, topScore }) => {
  ...
  return (
    <div className="b--moon-gray bb br bg-white-60 flex relative z-0">
      <div className="b--black-20 br cell-number flex items-center justify-end pa1 pa2-ns">
        <span>{index + 1}</span>
      </div>
      <div className="b--black-20 br cell-name flex items-center pa1 pa2-ns">
      ...
      <div className="b b--black-20 cell-number flex items-center justify-end pa1 pa2-ns">
